$(document).ready(function() {
    ...
    $("#contact-form").submit(function(event) {
        emailjs.init('3Fe0WbX9d6hz5OfIa');

        emailjs.sendForm('service_okgm8s5', 'template_bnhhn1k', '#contact-form')
...
function sendMail(){
    ...
    emailjs.send("service_okgm8s5","template_bnhhn1k", parms).then(alert("Email Sent!!"));
}
...
document.addEventListener('visibilitychange',
    function() {
        if (document.visibilityState === "visible") {
            ...
            $("#cat").attr("href", "assets/images/cat.png");
        } else {
...
var typed = new Typed(".typing-text", {
    strings: ["Software Developer","Front End Developer","React Developer","Web Developer"],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
    backDelay: 500,
